...
void protobuf_AssignDesc_odom_2eproto() {
  ...
  static const int odom_offsets_[7] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, usec_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, position_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, orientation_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, linear_velocity_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, angular_velocity_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, pose_covariance_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(odom, twist_covariance_),
  };
  odom_reflection_ =
...
void protobuf_AddDesc_odom_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    "\n\nodom.proto\022\016odom_msgs.msgs\032\020quaternion"
    ".proto\032\016vector3d.proto\"\207\002\n\004odom\022\014\n\004usec\030"
    "\001 \002(\005\022\'\n\010position\030\002 \002(\0132\025.gazebo.msgs.Ve"
    "ctor3d\022,\n\013orientation\030\003 \002(\0132\027.gazebo.msg"
    "s.Quaternion\022.\n\017linear_velocity\030\004 \002(\0132\025."
    "gazebo.msgs.Vector3d\022/\n\020angular_velocity"
    "\030\005 \002(\0132\025.gazebo.msgs.Vector3d\022\033\n\017pose_co"
    "variance\030\006 \003(\002B\002\020\001\022\034\n\020twist_covariance\030\007"
    " \003(\002B\002\020\001", 328);
...
const int odom::kOrientationFieldNumber;
const int odom::kLinearVelocityFieldNumber;
const int odom::kAngularVelocityFieldNumber;
const int odom::kPoseCovarianceFieldNumber;
const int odom::kTwistCovarianceFieldNumber;
#endif  // !_MSC_VER
